			...
			<form method="post" action="{{route('active.vendor.approve')}}" enctype="multipart/form-data">
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9 text-secondary">
						<input type="text" class="form-control" value="{{$inactiveVendorDetails->username}}" name="username" disabled/>
					</div>
				</div>
				<div class="row mb-3">
					<div class="col-sm-3">
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9 text-secondary">
                    <img id="showImage" src="{{(!empty($inactiveVendorDetails->photo)) ? url('upload/vendor_images/'.$inactiveVendorDetails->photo):url('upload/no_image.jpg')}}" alt="Vendor" style = "width: 100; height:100px;">
					</div>
				</div>
