           ...
           <div class="border border-3 p-4 rounded">
            ...
            <div class="mb-3">
			  ...
			  <div class="form-group mb-3">
				...
				<textarea name="short_description" class="form-control" id="inputProductDescription" rows="3">{{$products->short_description}}</textarea>
			  </div>

			   <div class="mb-3">
				<label for="inputProductDescription" class="form-label">Long Description</label>
				<textarea name="long_description" class="form-control" id="inputProductDescription" rows="3">{{$products->long_description}}</textarea>
			  </div>
...
<div class="page-content">
	<h6 class="mb-0 text-uppercase">Update Product Images </h6>
	<hr>
<div class="card">
<div class="card-body">
